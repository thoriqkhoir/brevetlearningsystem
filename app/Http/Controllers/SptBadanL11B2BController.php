...
class SptBadanL11B2BController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $record = SptBadanL11B2B::findOrFail($id);
        $record->update([
            'cost_breakdown'   => $validated['cost_breakdown'],
            'month_balance_1'  => $validated['month_balance_1']  ?? 0,
            'month_balance_2'  => $validated['month_balance_2']  ?? 0,
    ...
    public function destroy(Request $request)
    {
        ...
        SptBadanL11B2B::whereIn('id', $validated['ids'])->delete();
