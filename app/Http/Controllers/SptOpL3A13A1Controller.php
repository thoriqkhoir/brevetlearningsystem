...
class SptOpL3A13A1Controller extends Controller
{
    ...
    public function sync(Request $request)
    {
        $validated = $request->validate([
            ...
            'rows.*.commercial_value' => ['nullable', 'integer'],
            'rows.*.non_taxable' => ['nullable', 'integer'],
            'rows.*.subject_to_final' => ['nullable', 'integer'],
            'rows.*.non_final' => ['nullable', 'integer'],
            'rows.*.positive_fiscal' => ['nullable', 'integer'],
            'rows.*.negative_fiscal' => ['nullable', 'integer'],
