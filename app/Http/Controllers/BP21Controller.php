...
class BP21Controller extends Controller
{
    public function index()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('BP21/NotIssued', [
                'bupots' => [],
        ...
        $bupots = Bupot::with('object')
            ...
            ->whereHas('object', function ($query) {
                $query->where('type', 'selain pegawai');
            })
    ...
    public function issued()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('BP21/Issued', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function invalid()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('BP21/Invalid', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function show($id)
    {
        ...
        $bupot = Bupot::with('object')
            ...
            ->firstOrFail();
        return Inertia::render('BP21/BP21', [
            'user' => $user,
            'bupot' => $bupot,
            'active_course_id' => $activeCourseId,
            'no_active_course' => false,
    ...
    public function create()
    {
        ...
        $activeCourseId = session('active_course_id');
        if (!$activeCourseId) {
            return Inertia::render('BP21/FormCreateBP21', [
                'user' => $user,
                'objects' => [],
                'bupots' => [],
                'ter' => [],
        ...
        $objects = MasterObject::where('type', 'selain pegawai')->get();
        $bupots = Bupot::with('object')
            ->where('user_id', $user->id)
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bp21.notIssued')->with('success', 'e-Bupot BP21 berhasil dibuat');
        } catch (\Exception $e) {
            return redirect()->route('bp21.notIssued')->with('success', 'Terjadi kesalahan saat membuat e-Bupot BP21');
        }
    }
    ...
    public function edit($id)
    {
        ...
        $objects = MasterObject::where('type', 'selain pegawai')->get();
        $ter = MasterTer::all();
        return Inertia::render('BP21/FormEditBP21', [
            'user' => $user,
            'bupot' => $bupot,
            'objects' => $objects,
            'ter' => $ter,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('bp21.notIssued')->with('success', 'e-Bupot BP21 berhasil diedit');
        } catch (\Exception $e) {
            return redirect()->route('bp21.notIssued')->with('success', 'Terjadi kesalahan saat mengedit e-Bupot BP21');
        }
    }
    ...
    public function updateStatusMultiple(Request $request)
    {
        ...
        $activeCourseId = session('active_course_id');
        if (!$activeCourseId) {
            return redirect()->route('bp21.notIssued')->with('error', 'No active course selected');
        }

        if (!Hash::check($request->password, $user->password)) {
            return redirect()->route('bp21.notIssued')->with('error', 'Password salah!');
        }
        ...
        try {
            ...
            return redirect()->route('bp21.issued')->with('success', 'Status e-Bupot BP21 berhasil diperbarui.');
        } catch (\Exception $e) {
            return redirect()->route('bp21.notIssued')->with('error', 'Status e-Bupot BP21 gagal diperbarui.');
        }
    }
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bp21.notIssued')->with('success', 'e-Bupot BP21 berhasil dihapus.');
        } catch (\Exception $e) {
            return redirect()->route('bp21.notIssued')->with('error', 'Gagal menghapus e-Bupot BP21.');
        }
    }
    ...
    public function downloadPDF($id)
    {
        ...
        return $pdf->stream('bp21_' . $bupot->bupot_number . '_' . $bupot->customer_id . '.pdf');
    }
}
