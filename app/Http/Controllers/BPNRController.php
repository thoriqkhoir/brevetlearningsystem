...
class BPNRController extends Controller
{
    public function index()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('BPNR/NotIssued', [
                'bupots' => [],
        ...
        $bupots = Bupot::with('object')
            ...
            ->whereHas('object', fn($q) => $q->where('type', 'bpnr'))
    ...
    public function issued()
    {
        ...
        $activeCourseId = session('active_course_id');
        if (!$activeCourseId) {
            return Inertia::render('BPNR/Issued', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function invalid()
    {
        ...
        $activeCourseId = session('active_course_id');
        if (!$activeCourseId) {
            return Inertia::render('BPNR/Invalid', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function show($id)
    {
        ...
        $bupot = Bupot::with('object')
            ...
            ->firstOrFail();
        return Inertia::render('BPNR/BPNR', [
            'user' => $user,
            'bupot' => $bupot,
            'active_course_id' => $activeCourseId,
        ]);
    ...
    public function create()
    {
        ...
        $activeCourseId = session('active_course_id');
        if (!$activeCourseId) {
            return Inertia::render('BPNR/FormCreateBPNR', [
                'user' => $user,
                'objects' => [],
                'bupots' => [],
                'active_course_id' => null,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bpnr.notIssued')->with('success', 'BPNR berhasil dibuat');
        } catch (\Exception $e) {
            return redirect()->route('bpnr.notIssued')->with('success', 'Terjadi kesalahan saat membuat BPNR');
        }
    }
    ...
    public function edit($id)
    {
        ...
        $bupot = Bupot::where('id', $id)
            ...
            ->firstOrFail();
        $objects = MasterObject::where('type', 'bpnr')->get();
        return Inertia::render('BPNR/FormEditBPNR', [
            'user' => $user,
            'bupot' => $bupot,
            'objects' => $objects,
            'active_course_id' => $activeCourseId,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('bpnr.notIssued')->with('success', 'BPNR berhasil diedit');
        } catch (\Exception $e) {
            return redirect()->route('bpnr.notIssued')->with('success', 'Terjadi kesalahan saat mengedit BPNR');
        }
    }
    ...
    public function updateStatusMultiple(Request $request)
    {
        ...
        if (!Hash::check($request->password, $user->password)) {
            return redirect()->route('bpnr.notIssued')->with('error', 'Password salah!');
        }
        ...
        try {
            ...
            return redirect()->route('bpnr.issued')->with('success', 'Status eBupot berhasil diperbarui.');
        } catch (\Exception $e) {
            return redirect()->route('bpnr.notIssued')->with('error', 'Status eBupot gagal diperbarui.');
        }
    }
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bpnr.notIssued')->with('success', 'eBupot berhasil dihapus.');
        } catch (\Exception $e) {
            return redirect()->route('bpnr.notIssued')->with('error', 'Gagal menghapus eBupot.');
        }
    }
    ...
    public function downloadPDF($id)
    {
        ...
        return $pdf->stream('bpnr_' . $bupot->bupot_number . '_' . $bupot->customer_id . '.pdf');
    }
}
