...
class MPController extends Controller
{
    public function index()
    {
        ...
        // Jika belum memilih kelas aktif, kirimkan list kosong dengan flag
        if (!$activeCourseId) {
            return Inertia::render('MP/NotIssued', [
                'bupots' => [],
        ...
        $bupots = Bupot::with('object')
            ...
            ->whereHas('object', fn($q) => $q->where('type', 'pegawai'))
    ...
    public function issued()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('MP/Issued', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function invalid()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('MP/Invalid', [
                'bupots' => [],
                'active_course_id' => null,
                'no_active_course' => true,
            ]);
    ...
    public function show($id)
    {
        ...
        if (!$activeCourseId) {
            // Tidak ada kelas aktif, cegah akses data lintas kelas
    ...
    public function create()
    {
        ...
        if (!$activeCourseId) {
            return Inertia::render('MP/FormCreateMP', [
                'user' => $user,
                'objects' => [],
                'bupots' => [],
                'ter' => [],
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('mp.notIssued')->with('success', 'BPPU berhasil dibuat');
        } catch (\Exception $e) {
            return redirect()->route('mp.notIssued')->with('success', 'Terjadi kesalahan saat membuat BPPU');
        }
    }
    ...
    public function edit($id)
    {
        ...
        $objects = MasterObject::where('type', 'pegawai')->get();
        $ter = MasterTer::all();
        return Inertia::render('MP/FormEditMP', [
            'user' => $user,
            'bupot' => $bupot,
            'objects' => $objects,
            'ter' => $ter,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('mp.notIssued')->with('success', 'eBupot MP berhasil diedit');
        } catch (\Exception $e) {
            return redirect()->route('mp.notIssued')->with('success', 'Terjadi kesalahan saat mengedit eBupot MP');
        }
    }
    ...
    public function updateStatusMultiple(Request $request)
    {
        ...
        if (!Hash::check($request->password, $user->password)) {
            return redirect()->route('mp.notIssued')->with('error', 'Password salah!');
        }
        ...
        try {
            ...
            return redirect()->route('mp.issued')->with('success', 'Status eBupot MP berhasil diperbarui.');
        } catch (\Exception $e) {
            return redirect()->route('mp.notIssued')->with('error', 'Status eBupot MP gagal diperbarui.');
        }
    }
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('mp.notIssued')->with('success', 'eBupot MP berhasil dihapus.');
        } catch (\Exception $e) {
            return redirect()->route('mp.notIssued')->with('error', 'Gagal menghapus eBupot MP.');
        }
    }
    ...
    public function downloadPDF($id)
    {
        ...
        return $pdf->stream('mp_' . $bupot->bupot_number . '_' . $bupot->customer_id . '.pdf');
    }
}
