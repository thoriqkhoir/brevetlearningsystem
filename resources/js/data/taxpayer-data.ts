export const countries = [
    ...
    { value: "Afrika Selatan", label: "Afrika Selatan" },
    { value: "Afrika Tengah", label: "Afrika Tengah" },
    { value: "Albania", label: "Albania" },
    { value: "Aljazair", label: "Aljazair" },
    { value: "Amerika Serikat", label: "Amerika Serikat" },
    { value: "Andorra", label: "Andorra" },
    { value: "Angola", label: "Angola" },
    { value: "Antigua dan Barbuda", label: "Antigua dan Barbuda" },
    ...
    { value: "Bosnia dan Herzegovina", label: "Bosnia dan Herzegovina" },
    ...
    { value: "Republik Dominika", label: "Republik Dominika" },
    { value: "Ekuador", label: "Ekuador" },
    ...
    { value: "Guinea Khatulistiwa", label: "Guinea Khatulistiwa" },
    { value: "Guyana", label: "Guyana" },
    { value: "Haiti", label: "Haiti" },
    { value: "Honduras", label: "Honduras" },
    { value: "Hongaria", label: "Hongaria" },
    ...
    { value: "Korea Utara", label: "Korea Utara" },
    { value: "Kosta Rika", label: "Kosta Rika" },
    { value: "Kroasia", label: "Kroasia" },
    ...
    { value: "Maladewa", label: "Maladewa" },
    { value: "Mali", label: "Mali" },
    { value: "Malta", label: "Malta" },
    { value: "Maroko", label: "Maroko" },
    { value: "Kepulauan Marshall", label: "Kepulauan Marshall" },
    { value: "Mauritania", label: "Mauritania" },
    { value: "Mauritius", label: "Mauritius" },
    { value: "Meksiko", label: "Meksiko" },
    { value: "Mikronesia", label: "Mikronesia" },
    ...
    { value: "Papua Nugini", label: "Papua Nugini" },
    { value: "Paraguay", label: "Paraguay" },
    { value: "Peru", label: "Peru" },
    { value: "Polandia", label: "Polandia" },
    { value: "Portugal", label: "Portugal" },
    { value: "Qatar", label: "Qatar" },
    { value: "Republik Ceko", label: "Republik Ceko" },
    { value: "Republik Demokratik Kongo", label: "Republik Demokratik Kongo" },
    { value: "Republik Kongo", label: "Republik Kongo" },
    { value: "Romania", label: "Romania" },
    { value: "Rusia", label: "Rusia" },
    { value: "Rwanda", label: "Rwanda" },
    { value: "Saint Kitts dan Nevis", label: "Saint Kitts dan Nevis" },
    ...
    { value: "Sao Tome dan Principe", label: "Sao Tome dan Principe" },
    ...
    { value: "Kepulauan Solomon", label: "Kepulauan Solomon" },
    { value: "Somalia", label: "Somalia" },
    { value: "Spanyol", label: "Spanyol" },
    { value: "Sri Lanka", label: "Sri Lanka" },
    { value: "Sudan", label: "Sudan" },
    { value: "Sudan Selatan", label: "Sudan Selatan" },
    { value: "Suriname", label: "Suriname" },
    { value: "Swaziland", label: "Swaziland" },
    { value: "Swedia", label: "Swedia" },
    { value: "Swiss", label: "Swiss" },
    { value: "Suriah", label: "Suriah" },
    ...
    { value: "Trinidad dan Tobago", label: "Trinidad dan Tobago" },
    ...
    { value: "Uni Emirat Arab", label: "Uni Emirat Arab" },
...
export const maritalStatuses = [
    ...
    { value: "Tidak Kawin", label: "Tidak Kawin" },
...
export const religions = [
    ...
    {
        value: "Kepercayaan Terhadap Tuhan YME",
...
export const individualCategories = [
    {
        value: "Istri dengan perjanjian penghasilan dan harta (PH)",
        label: "Istri dengan perjanjian penghasilan dan harta (PH)",
    },
    {
        value: "Istri memilih menjalankan hak dan kewajiban perpajakan terpisah (MT)",
        label: "Istri memilih menjalankan hak dan kewajiban perpajakan terpisah (MT)",
    },
    { value: "Orang Pribadi", label: "Orang Pribadi" },
    { value: "Orang Pribadi SPLN", label: "Orang Pribadi SPLN" },
    {
        value: "Wanita yang telah hidup terpisah berdasarkan keputusan hakim (HB)",
        label: "Wanita yang telah hidup terpisah berdasarkan keputusan hakim (HB)",
    },
    {
        value: "Warisan yang belum terbagi satu kesatuan menggantikan yang berhak (WBT)",
        label: "Warisan yang belum terbagi satu kesatuan menggantikan yang berhak (WBT)",
    },
];
...
export const occupations = [
    ...
    { value: "Anggota DPD RI", label: "Anggota DPD RI" },
    { value: "Anggota DPR RI", label: "Anggota DPR RI" },
    { value: "Anggota DPRD Kab/Kota", label: "Anggota DPRD Kab/Kota" },
    { value: "Anggota DPRD Provinsi", label: "Anggota DPRD Provinsi" },
    {
        value: "Anggota Kabinet Kementrian",
        label: "Anggota Kabinet Kementrian",
    },
    {
        value: "Anggota Lembaga Tinggi Lainnya",
        label: "Anggota Lembaga Tinggi Lainnya",
    },
    {
    ...
    { value: "Atlit", label: "Atlit" },
    { value: "Belum/Tidak Bekerja", label: "Belum/Tidak Bekerja" },
    { value: "Biarawan/Biarawati", label: "Biarawan/Biarawati" },
    ...
    {
        value: "Pegawai Pengolahan Kerajinan",
        label: "Pegawai Pengolahan Kerajinan",
    },
    ...
    { value: "Pedagang", label: "Pedagang" },
    { value: "Petani/Berkebun", label: "Petani/Berkebun" },
    ...
    { value: "Radio Penyiar", label: "Radio Penyiar" },
    { value: "Seniman", label: "Seniman" },
    { value: "Sopir", label: "Sopir" },
    { value: "Tabib", label: "Tabib" },
    { value: "Teknisi", label: "Teknisi" },
    { value: "Tenaga Tata Usaha", label: "Tenaga Tata Usaha" },
    {
        value: "Tentara Nasional Indonesia (TNI)",
        label: "Tentara Nasional Indonesia (TNI)",
    },
