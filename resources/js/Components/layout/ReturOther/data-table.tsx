...
interface DataTableReturOtherProps<TData, TValue> {
    columns: ColumnDef<TData, TValue>[];
    data: TData[];
    setSelectedIds: (ids: string[]) => void;
}

export function DataTableReturOther<TData extends { id: string }, TValue>({
    columns,
    data,
    setSelectedIds,
}: DataTableReturOtherProps<TData, TValue>) {
