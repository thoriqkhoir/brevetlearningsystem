...
export default function Edit(props: { businessEntity: BusinessEntity }) {
    ...
    function onSubmit(values: BusinessEntityFormValues) {
        ...
        router.put(
            route("business-entities.update", businessEntity.id),
            payload,
        );
    }
