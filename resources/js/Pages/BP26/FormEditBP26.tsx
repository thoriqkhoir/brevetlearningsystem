...
export default function FormEditBP26({ user, bupot, objects }: any) {
    const form = useForm<z.infer<typeof formSchema>>({
        resolver: zodResolver(formSchema),
        defaultValues: {
            ...bupot,
            doc_date: new Date(bupot.doc_date),
            customer_birth_date: bupot.customer_birth_date
                ? new Date(bupot.customer_birth_date)
                : null,
        },
    });
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        router.put(route("bp26.update", bupot.id), formattedValues);
    }
