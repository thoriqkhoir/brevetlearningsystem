...
export default function NotIssued({ bupots }: any) {
    ...
    const handleDeleteSelected = (selectedIds: string[], password: string) => {
        router.delete(route("cy.deleteMultiple"), {
    ...
    return (
        <Authenticated>
            ...
            />
            <ConfirmDialog
                title="Terbitkan eBupot CY"
                description="Apakah Anda yakin ingin menerbitkan eBupot CY yang Anda pilih?"
            ...
            />
            <ConfirmDialog
                title="Hapus eBupot CY"
                description="Apakah Anda yakin ingin menghapus eBupot CY yang Anda pilih?"
