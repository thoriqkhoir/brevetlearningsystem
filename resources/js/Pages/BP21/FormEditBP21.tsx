...
export default function FormEditBP21({ user, bupot, objects, ter }: any) {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        router.put(route("bp21.update", bupot.id), formattedValues);
    }
            ...
            <div className="py-8 mx-auto lg:px-4">
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <Breadcrumb>
                        <BreadcrumbList>
                            <BreadcrumbItem>
                                <Link href={route("bp21.notIssued")}>
                                    BP21 Belum Terbit
                                </Link>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
