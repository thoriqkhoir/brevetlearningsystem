...
export default function TabL1J(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="j"
            a1Categories={A1J}
            heading="REKONSILIASI LAPORAN KEUANGAN - INFRASTRUKTUR"
        />
    );
}
...
function LegacyTabL1J({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1J as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - INFRASTRUKTUR
            </h2>
