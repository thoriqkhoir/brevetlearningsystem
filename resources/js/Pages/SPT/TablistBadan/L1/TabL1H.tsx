...
export default function TabL1H(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="h"
            a1Categories={A1H}
            heading="REKONSILIASI LAPORAN KEUANGAN - PROPERTI"
        />
    );
}
...
function LegacyTabL1H({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1H as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - PROPERTI
            </h2>
