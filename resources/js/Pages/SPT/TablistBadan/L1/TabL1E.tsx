...
export default function TabL1E(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="e"
            a1Categories={A1E}
            heading="REKONSILIASI LAPORAN KEUANGAN - BANK KONVENSIONAL"
        />
    );
}
...
function LegacyTabL1E({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1E as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - BANK KONVENSIONAL
            </h2>
