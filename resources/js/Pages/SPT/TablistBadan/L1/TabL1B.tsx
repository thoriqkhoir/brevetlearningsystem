...
export default function TabL1B(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="b"
            a1Categories={A1B}
            heading="REKONSILIASI LAPORAN KEUANGAN - MANUFAKTUR"
...
function LegacyTabL1B({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1B as readonly string[];
