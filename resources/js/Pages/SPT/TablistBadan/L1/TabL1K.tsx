...
export default function TabL1K(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="k"
            a1Categories={A1K}
            heading="REKONSILIASI LAPORAN KEUANGAN - SEKURITAS"
        />
    );
}
...
function LegacyTabL1K({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1K as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - SEKURITAS
            </h2>
