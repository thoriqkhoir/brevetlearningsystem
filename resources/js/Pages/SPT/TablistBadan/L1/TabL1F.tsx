...
export default function TabL1F(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="f"
            a1Categories={A1F}
            heading="REKONSILIASI LAPORAN KEUANGAN - DANA PENSIUN"
        />
    );
}
...
function LegacyTabL1F({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1F as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - DANA PENSIUN
            </h2>
