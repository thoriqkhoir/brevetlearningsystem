...
export default function TabL1I(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="i"
            a1Categories={A1I}
            heading="REKONSILIASI LAPORAN KEUANGAN - BANK SYARIAH"
...
function LegacyTabL1I({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1I as readonly string[];
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
            <h2 className="text-xl font-semibold">
                REKONSILIASI LAPORAN KEUANGAN - BANK SYARIAH
            </h2>
