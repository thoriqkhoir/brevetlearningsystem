...
export default function TabL1C(props: L1AProps) {
    return (
        <TabL1AComponent
            {...props}
            sectorCode="c"
            a1Categories={A1C}
            heading="REKONSILIASI LAPORAN KEUANGAN - DAGANG"
        />
    );
}
...
function LegacyTabL1C({
    ...
    const a1Accounts = useMemo(() => {
        ...
        for (const acc of masterAccounts ?? []) {
            const cats = A1C as readonly string[];
