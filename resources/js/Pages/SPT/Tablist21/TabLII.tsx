...
const TabLII = forwardRef(
    (
        ...
        console.log('=== TabLII Debug ===');
        console.log('bupotA1:', bupotA1);
        console.log('bupotA2:', bupotA2);
        console.log('bupotA1 length:', bupotA1?.length || 0);
        console.log('bupotA2 length:', bupotA2?.length || 0);

        // Transform data untuk LIST-II dari BupotA1
        const dataBPA1 = [
            ...(bupotA1 || [])
        ...
        // Transform data untuk LIST-II dari BupotA2
        const dataBPA2 = [
            ...(bupotA2 || [])
                .map((item: any) => ({
                    npwp: item.customer_id || '',
        ...
        console.log('dataBPA1:', dataBPA1);
        console.log('dataBPA2:', dataBPA2);

        // Gabungkan data BPA1 dan BPA2
        const dataBppu = [...dataBPA1, ...dataBPA2];

        console.log('dataBppu (gabungan):', dataBppu);
        console.log('dataBppu length:', dataBppu.length);

        // Custom columns untuk LIST-II (tanpa persen pada tarif)
        ...
        return (
            <div>
                <h1 className="text-xl font-semibold mt-8 mb-2">
                    Daftar Pemotongan Satu Tahun Pajak Atau Bagian Tahun Pajak Pajak Penghasilan Pasal 21 Bagi Pegawai Tetap Dan Pensiunan Yang Menerima Uang Terkait Pensiun Secara Berkala Serta Bagi Pegawai Negeri Sipil, Anggota Tentara Nasional Indonesia, Anggota Kepolisian Republik Indonesia, Pejabat Negara, Dan Pensiunannya 
                </h1>
                <div className="bg-muted p-4 w-full rounded-t-xl">
                    <p className="font-semibold text-sm">List-II</p>
                </div>
                ...
                <div className="p-4 bg-white w-full rounded-b-xl">
                <Accordion type="single" collapsible className="w-full" defaultValue="II">
