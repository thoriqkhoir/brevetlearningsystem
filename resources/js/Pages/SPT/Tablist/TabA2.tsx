...
const TabA2 = forwardRef(
    (
        ...
        const data = [
            ...
            ...retur.map((ret: any) => {
                const relatedInvoice = invoice.find((inv: any) => 
                    inv.id === ret.invoice_id || 
                    inv.invoice_number === ret.invoice_number ||
                    inv.customer_id === ret.customer_id
                );
                
                return {
                    name: relatedInvoice?.customer_name || ret.customer_name || "",
                    npwp: relatedInvoice?.customer_id || ret.customer_id || "",
                ...
                return [
                    ...
                    ...retur.map((ret: any) => {
                        ...
                        return {
                            ...
                            no: ret.retur_number,
                            date: ret.retur_date,
                            customer_id: relatedInvoice?.customer_id || ret.customer_id || "",
                            customer_name: relatedInvoice?.customer_name || ret.customer_name || "",
                            customer_email: relatedInvoice?.customer_email || ret.customer_email || "",
                            customer_address: relatedInvoice?.customer_address || ret.customer_address || "",
                            dpp: -ret.dpp || 0,
