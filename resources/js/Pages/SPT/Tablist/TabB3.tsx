...
const TabB3 = forwardRef(
    (
        ...
        const filteredInvoice = (invoice || []).filter(
            (inv: any) => inv.type === "masukan" && inv.status === "uncredit"
        );
        const filteredRetur = (retur || []).filter(
            (ret: any) => ret.type === "masukan"
        );
        ...
        return (
            <div>
                <h1 className="text-xl font-semibold mt-8 mb-2">
                    Daftar Pajak Masukan yang Tidak Dapat Dikreditkan atau yang
                    Mendapat Fasilitas
                </h1>
