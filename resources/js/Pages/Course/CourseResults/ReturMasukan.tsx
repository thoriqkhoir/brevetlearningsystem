...
export default function ReturMasukan({
    returs,
    courseResults,
}: {
    returs: any[];
    ...
    if (returs.filter((retur: any) => retur.type === "masukan").length === 0) {
        return (
            <div className="mb-4 rounded-xl bg-sidebar border p-4">
                <h2 className="font-semibold mb-2">Retur Pajak Masukan</h2>
                <p className="text-gray-500">
                    Belum ada retur pajak masukan yang dibuat.
                </p>
            </div>
        );
    }
        ...
        <div className="mb-4 rounded-xl bg-sidebar border p-4">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full border text-sm">
                    ...
                    <tbody>
                        {returs
                            .filter((retur: any) => retur.type === "masukan")
