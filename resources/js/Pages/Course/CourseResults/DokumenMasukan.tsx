...
export default function DokumenMasukan({
    others,
    courseResults,
}: {
    others: any[];
    ...
    if (others.filter((other: any) => other.type === "masukan").length === 0) {
        return (
            <div className="mb-4 rounded-xl bg-sidebar border p-4">
                <h2 className="font-semibold mb-2">Dokumen Lain Masukan</h2>
                <p className="text-gray-500">
                    Belum ada dokumen lain masukan yang dibuat.
                </p>
            </div>
        );
    }
        ...
        <div className="mb-4 rounded-xl bg-sidebar border p-4">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full border text-sm">
                    ...
                    <tbody>
                        {others
                            .filter((other: any) => other.type === "masukan")
