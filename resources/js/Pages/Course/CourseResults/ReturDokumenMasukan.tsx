...
export default function ReturDokumenMasukan({
    returOthers,
    courseResults,
}: {
    returOthers: any[];
    ...
    if (
        returOthers.filter((retur: any) => retur.type === "masukan").length ===
        0
    ) {
        return (
            <div className="mb-4 rounded-xl bg-sidebar border p-4">
                ...
                <p className="text-gray-500">
                    Belum ada retur dokumen lain masukan yang dibuat.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="mb-4 rounded-xl bg-sidebar border p-4">
            <h2 className="font-semibold mb-2">Retur Dokumen Lain Masukan</h2>
