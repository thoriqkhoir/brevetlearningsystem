...
export default function ReturDokumenPajakMasukan({ returs }: any) {
    ...
    return (
        <Authenticated>
            ...
            />
            <ConfirmDialog
                title="Laporkan Retur Dokumen Masukan"
                description="Apakah Anda yakin ingin melaporkan retur dokumen masukan yang Anda pilih?"
            ...
            />
            <ConfirmDialog
                title="Batalkan Retur Dokumen Masukan"
                description="Apakah Anda yakin ingin membatalkan retur dokumen masukan yang Anda pilih?"
