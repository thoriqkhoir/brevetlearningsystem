...
import FormFieldsInvoiceDocument from "./FormFieldsTransactionDocument";
...
export default function FormEditInputInvoice({
    invoice,
    items,
    invoiceCount,
}: any) {
    ...
    return (
        <Authenticated>
            <Head title="Edit Faktur Pajak Masukan" />
