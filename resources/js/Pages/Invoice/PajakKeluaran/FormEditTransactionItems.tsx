...
export default function FormEditTransactionItems({
    item,
    updateItem,
    openEditModal,
    setOpenEditModal,
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            dpp_lain:
                item.dpp_lain ||
                item.item_price * item.item_quantity - item.item_discount,
        },
    });
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        updateItem({ ...values, id: item.id });
        console.log({ ...values, id: item.id });
    ...
    return (
        <Dialog open={openEditModal} onOpenChange={setOpenEditModal}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>Edit Transaction Item</DialogTitle>
                </DialogHeader>
                <Form {...form}>
                    <form
                        onSubmit={(e) => {
