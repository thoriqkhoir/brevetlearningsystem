...
export default function NotIssued({ bupots }: any) {
    ...
    const handleDeleteSelected = (selectedIds: string[], password: string) => {
        router.delete(route("sp.deleteMultiple"), {
    ...
    return (
        <Authenticated>
            ...
            />
            <ConfirmDialog
                title="Terbitkan eBupot SP"
                description="Apakah Anda yakin ingin menerbitkan eBupot SP yang Anda pilih?"
            ...
            />
            <ConfirmDialog
                title="Hapus eBupot SP"
                description="Apakah Anda yakin ingin menghapus eBupot SP yang Anda pilih?"
