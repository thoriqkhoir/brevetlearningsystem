...
export default function FormCreateMP({ user, objects, bupots, ter }: any) {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        router.post(route("mp.store"), formattedValues);
    }
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Buat eBupot MP</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
