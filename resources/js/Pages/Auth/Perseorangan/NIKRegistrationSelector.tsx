...
import { Check, X, MoveLeft, IdCard, FileText } from "lucide-react";
...
export default function RegistrationPortal() {
    ...
    const registrationTypes = [
        {
            id: "nik-registration",
            title: "Pendaftaran dengan Aktivasi NIK / Aktivasi NIK",
            icon: IdCard,
            color: "bg-gradient-to-br from-blue-600 to-blue-800",
            available: true,
        },
        {
            id: "domestic-nik-registration",
            title: "Hanya Registrasi",
            icon: FileText,
                ...
                <CardContent>
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 max-w-4xl mx-auto text-sm md:text-base">
                            Silahkan pilih jenis pendaftaran yang sesuai untuk
                            Nomor Induk Kependudukan (NIK) Anda.
                        </p>
                    </div>

                    <div className="grid grid-cols-2 gap-6 mb-4 max-w-lg mx-auto">
                    ...
                    <div className="flex justify-center md:mt-10 md:mb-4">
                        <Button variant="outline" asChild>
                            <Link href={route("individual-registration")}>
