...
export default function CreateQuestion({
    ...
    const [options, setOptions] = useState<
        Array<{ text: string; is_correct: boolean; image?: File | null }>
    >([
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (values.question_type === "multiple_choice") {
            // Kirim data opsi tanpa file gambar (hanya text dan is_correct)
            ...
            // Convert to options format for true/false
        ...
        router.post(
            route("teacher.questionBankQuestions.store", bankId),
            formData,
            {
                forceFormData: true,
            },
    ...
    return (
        <TeacherLayout>
            <Head title={`Tambah Soal Bank - ${bankName}`} />
                ...
                <div className="teacher-page-stack">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Tambah Soal</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                    ...
                    <div className="rounded-md border border-blue-200 bg-blue-50 p-3 text-sm text-blue-800">
                        ...
                        . Soal yang dibuat di halaman ini akan dipakai oleh
                        semua ujian yang memakai bank soal ini.
                    </div>
                                            ...
                                            <FormItem>
                                                ...
                                                <Select
                                                    onValueChange={(value) => {
                                                        ...
                                                        // Reset options when changing type (keep at least 2 empty)
                                                        if (
                                                            value !==
                                                            "multiple_choice"
                                                        ) {
                                                            ...
                                                            <div className="ml-20">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    <Input
                                                                        ...
                                                                        key={`option-image-input-${index}-${option.image ? "has-image" : "no-image"}`}
                                                                        type="file"
                                                                        accept="image/*"
                                                                        onChange={(
                                                                            e,
