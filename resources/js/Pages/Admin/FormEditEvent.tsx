...
export default function FormEditEvent({ event }: any) {
    ...
    useEffect(() => {
        if (nameValue) {
            ...
            const existingNumber = event.code.slice(-3);
            const code = `${letters}${existingNumber}`;
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        router.put(route("admin.updateEvent", event.id), formattedValues);
    }
