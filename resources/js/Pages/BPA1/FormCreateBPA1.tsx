...
const formSchema = z.object({
    ...
    customer_address: z.string().min(1, "Alamat wajib diisi").max(255),
    ...
    facility: z.enum([
     ...
     kap: z.string().optional().or(z.literal("")), // ← UBAH INI
    nitku: z.string().optional().or(z.literal("")), // ← UBAH INI
    status: z.enum([
        "created",
        "approved",
        "canceled",
...
export default function FormCreateBPA1({ user, objects, bupots, ter }: any) {
    ...
    router.post(route("bpa1.store"), values, {
        onStart: () => {
...
function handleSubmitWithStatus(status: "created" | "draft") {
    ...
    // Ambil semua values setelah status di-set
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <Button
                                    type="button"
                                    className="mr-2"
                                    onClick={() => handleSubmitWithStatus("created")}
                                >
                                    Kirim
                                </Button>
                                <Button
