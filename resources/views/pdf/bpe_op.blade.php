...
<head>
    <title>Bukti Penerimaan Elektronik – SPT Tahunan PPh Orang Pribadi</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        <img src="{{ public_path('images/logo.png') }}" alt="TBrevet Learning System" style="width: 160px;">
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value">: SPT Tahunan PPh Orang Pribadi (1770)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value">:
                @if($sptOp->e_11_c == 0)
                    Nihil (0)
                @elseif($sptOp->e_11_c < 0)
                    Lebih Bayar (Rp {{ number_format(abs($sptOp->e_11_c), 0, ',', '.') }})
                @else
                    Kurang Bayar (Rp {{ number_format($sptOp->e_11_c, 0, ',', '.') }})
                @endif
            </td>
        </tr>
        <tr>
            <td class="label">PPh Kurang Bayar (E.11.c)</td>
            <td class="value">: Rp {{ number_format($sptOp->e_11_c ?? 0, 0, ',', '.') }}</td>
        </tr>
        <tr>
            <td class="label">Penandatangan</td>
            <td class="value">: {{ $sptOp->k_signer ?? $user->name }}</td>
        </tr>
        <tr>
    ...
    <div class="footer-note">
        ...
        SPT Tahunan PPh Orang Pribadi. BPE ini sah tanpa tanda tangan basah.
    </div>
